                ...
                <div id="Grid">
                     ...
                     <div class="col-md-4 mix students" data-cat="3">
                        <div class="gallery-item">
                            <a class="fancybox" rel="gallery1" title="<?=$g['title_img']?>" href="<?=site_url(); ?>file/galeri/<?php echo $g['image_url'] ;?>">
                                <div class="gallery-thumb">
                                    <img src="<?=site_url(); ?>file/galeri/<?php echo $g['image_url'] ;?>" alt="" />
                                </div>
                                <div class="gallery-content">
                                    <h4 class="gallery-title"><?php echo $g['title_img'] ;?></h4>
                                    <p class="small-text"><?php echo $g['description'] ;?></p>
                                </div>
                            </a>
                        </div> <!-- /.gallery-item -->
                    </div> <!-- /.col-md-4 -->
